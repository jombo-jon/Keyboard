...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT_atreus_wrapper( /*Qwerty */
    ...
    KC_MPLY, _______, KC_DEL,MO(_SYMBOLS), CCCV, _______, _______ , KC_SPC,LT(_NUMBERS,KC_SPC),KC_BSPC, _______, MO(_OPTIONS)
  ),
    ...
    _______, _______, KC_DEL, MO(_NAV), KC_EQL,   _______, _______, _______, _______, KC_BSPC, KC_0, KC_EQL 
  ),
...
[_OPTIONS] = LAYOUT( 
    UNIWL, _______, _______, _______, _______,                   _______, _______, _______, _______, _______, 
