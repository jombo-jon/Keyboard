...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT_atreus_wrapper( /*Qwerty */
    ...
    _________________QWERTY_L3_________________,             _______, KC_CAPS, _________________QWERTY_R3_________________,
    KC_MPLY, _______, KC_DEL,MO(_SYMBOLS), LT(_ACCENTS,CCCV), CCCV,MO(_OPTIONS), MO(_GREEK) , LT(_NUMBERS,KC_SPC),KC_BSPC, _______, MO(_OPTIONS)
  ),
    ...
    _________________NUMBER_L3_________________, _______, KC_CAPS, _________________NUMBER_R3_________________,
    _______, _______, KC_DEL, LT(_NAV,KC_EQL), KC_EQL,   _______, _______, _______, _______, KC_BSPC, KC_0, KC_EQL 
  ),
  [_SYMBOLS] = LAYOUT_atreus_wrapper(
    ...
    _______,_______ , _______, _______, _______, _______,_______,_______,  MO(_NAV),  _______, _______,_______
    ),
...
[_GREEK] = LAYOUT_atreus_wrapper(
    ...
    ________________GREEK_L3___________________, _______, _______, ________________GREEK_R3___________________,
    _______, _______, _______, _______, MO(_EMOJIS), _______, _______, _______, _______, _______, _______, _______
    ),
[_ACCENTS] = LAYOUT_atreus_wrapper( 
    ...
    _______, _______, _______, _______, _______, _______, _______, MO(_EMOJIS), _______, _______, _______, _______
   ),
[_EMOJIS] = LAYOUT_atreus_wrapper( 
    _________________EMOJI_L1_________________,                   _________________EMOJI_R1_________________,
    _________________EMOJI_L2_________________,                   _________________EMOJI_R2_________________,
    _________________EMOJI_L3_________________, _______, _______, _________________EMOJI_R3_________________,
    _______, _______, _______,_______,_______, _______, _______, _______, _______, _______, _______, _______
   ),
[_OPTIONS] = LAYOUT( 
    UNIWL, _______, _______, _______, RESET,                   _______, _______, _______, _______, _______, 
